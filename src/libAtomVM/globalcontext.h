 ...
 *
 * @details Checks if the given atom table index and the given AtomString referes to the same atom.
 * @param glb the global context.
 ...
 *
 * @details Checks if the given term and the given AtomString referes to the same atom.
 * @param glb the global context.
